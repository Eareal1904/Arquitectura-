...
#+AUTHOR: -Leonardo Shande Rodriguez Chaci,Samuel Alexander Churaco Guajan
          -
#+DATE: [26/05/2026]
...
1. *Integrante 1*
   ...
   - *Certificado adjunto:*
      ...
      #+caption: Certificado de Leonardo Rodriguez
      #+attr_latex: :scale=0.75
      #+label: fig:certificado-leonardo
...
** *Certificado adjunto:*
     ...
     #+caption: Certificado de José Jácome
...
3. *Integrante 3*
   ...
   - *Certificado adjunto:*
     ...
     #+caption: Certificado de Samuel Churaco
     #+attr_latex: scale=0.75
     #+label: fig:certificado-samuel churaco
...
** Integrante 3 [Samuel Churaco]
   - *¿Qué conocimiento nuevo obtuvo del curso?* En el curso nos enceño
