...
WSL. Las etapas del problema se subdividen en:
    ...
    3. Desarrollar un ejecutable /get-weather.sh/ para ejecutar el
       ...
       | cd              | /home/eareal/Arquitectura-/ProyectoNewYork |          |    |         |         |          |    |          |   |   |   |   |   |   |   |
       |                 |                                            |          |    |         |         |          |    |          |   |   |   |   |   |   |   |
       | #               | 2                                          | Activar  | el | entorno | de      | Anaconda |    |          |   |   |   |   |   |   |   |
...
#+RESULTS:
: Temp: 30.02°C, Humedad: 65%, Clima: Clouds
...
# AQUÍ ESTÁ LA RUTA RELATIVA UNIVERSAL
with open('../../clima-newyork-hoy.csv', mode='a', newline='') as archivo:
    writer = csv.writer(archivo)
    writer.writerow(linea)
...
df = pd.read_csv('../../clima-newyork-hoy.csv')
#+end_src

#+RESULTS:

#+caption: Tabla 1: Muestra aleatoria de 10 registros climáticos en New York.
#+begin_src python :session :exports results :results value table :return table
table1 = df.sample(10)
...
#+caption: Figura 1: Evolución de la temperatura en New York.
...
#+caption: Figura 2: Variación de la Humedad relativa en New York.
...
- [[file:page2-js.org][Página 2: Calculadora de Multiplicación IEEE 754]]
- [[file:page3-dashboard.org][Página 3: Dashboard de Robos de Vehículos (INEC)]]
* Referencias
