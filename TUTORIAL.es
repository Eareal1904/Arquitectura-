n Tutorial de Emacs.  Vea al final las condiciones de copiado.
...
>> Mueva el cursor al comienzo de una línea que no esté vacía.
   Luego teclee C-k para eliminar el texto de esa línea.>> Mueva el cursor al comienzo de una línea que no esté vacía.
   Luego teclee C-k para eliminar el texto de esa línea.>> Mueva el cursor al comienzo de una línea que no esté vacía.
   Luego teclee C-k para eliminar el texto de esa línea.>> Mueva el cursor al comienzo de una línea que no esté vacía.
   Luego teclee C-k para eliminar el texto de esa línea.>> Mueva el cursor al comienzo de una línea que no esté vacía.
   Luego teclee C-k para eliminar el texto de esa línea.>> Mueva el cursor al comienzo de una línea que no esté vacía.
   ...
   Luego teclee C-k para eliminar el texto de esa línea.>> Mueva el cursor al comienzo de una línea que no esté vacía.
   Luego teclee C-k para eliminar el texto de esa línea.>> Mueva el cursor al comienzo de una línea que no esté vacía.
   Luego teclee C-k para eliminar el texto de esa línea.líneas y sus nuevas líneas, tecleando C-k dos veces no hace esto.
...
>> Inténtelo; teclee C-y para pegar de nuevo el texto.>> Mueva el cursor al comienzo de una línea que no esté vacía.
...
Elimine una línea, muévase un poco, elimine otra línea.>> Elimine una línea, muévase un poco, elimine otra línea.
