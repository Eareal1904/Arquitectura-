...
proporcionadas en  la Sección \ref{sec:orgf654ee1} para
completar el taller.

\section{Instrucciones}
\label{sec:orgf654ee1}

\begin{enumerate}
\item Obtener las expresiones matemáticas para las ecuaciones
diferenciales ordinarias. Vea la Sección \ref{sec:org4114670}
...
proporcionado en la Sección \ref{sec:org5d2a18f}
...
\label{sec:org17c8fe7}
\subsection{SOLVE\textsubscript{IVP}}
\label{sec:org2e2c5b6}
