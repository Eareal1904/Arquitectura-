...
#+email: leonardo.rodriguez01@epn.edu.ec,jose.jacome04@epn.edu.ec,samuel.churaco@epn.edu.ec
 #+language: Espanol
 #+select_tags: export
...
#+begin_export latex
\fancyhead[C]{\includegraphics[scale=0.05]{./Fotos/logoEPN.jpg}\\
...
| *Comando* | *Descripción*                                      | *Comando* | *Descripción*                          |
|-----------+----------------------------------------------------+-----------+----------------------------------------|
| - C-h o   | - Se puede saltar de ventanas sin el uso del mouse | - C-y     | - Pega algo que se copio anteriormente |
|-----------+----------------------------------------------------+-----------+----------------------------------------|
| - M-w     | - Nos permite copiar algo seleccionado             | - C-x 1   | - Nos quedamos con una sola ventana    |
|-----------+----------------------------------------------------+-----------+----------------------------------------|
| - C-d     | - Borra caracteres al inverzo                      | - C-w     | - Corta algo seleccionado              |
|           |                                                    |           |                                        |
|-----------+----------------------------------------------------+-----------+----------------------------------------|
...
-Intento 1
  [[file:Fotos/IntentS1.png]]
-intento 2
  [[file:Fotos/IntentS2.png]]
-Intento 3
  [[file:Fotos/IntentS3.png]]
...
COUNT is the numeric prefix argument.  Return nil.
 >
3. **José Jácome:** <C-x u>. <C-x u runs the command undo (found in global-map), which is an
...
4. <C-x C-s> <It can also be invoked from the menu: File → Save
...
for SWITCHES.
>
3. **José Jácome:** <C-M-v>. <C-M-v runs the command scroll-other-window (found in global-map),
which is an interactive native-compiled Lisp function in ‘window.el’.
It is bound to M-<next>, C-M-v and ESC <next> .>
4. <C-x b> <Set the mark where point is, and activate it; or jump to the mark.
...
| Nombre             | email                           | Rol         |
|--------------------+---------------------------------+-------------|
| Samuel Churaco     | samuel.churaco@epn.edu.ec       | Líder       |
