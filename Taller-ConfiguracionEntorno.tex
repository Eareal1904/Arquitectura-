...
\end{verbatim}
 -Leonardo Rodriguez
[[\begin{center}
\includegraphics[width=.9\linewidth]{/home/samuchura-epn/imagenes/MambaEvidencia.jpeg}
\end{center}]]

\#+end\textsubscript{example}
-Samuel Churaco
[[\begin{center}
\includegraphics[width=.9\linewidth]{Imgess/infoMamba.png}
\end{center}]]
...
\end{verbatim}
 ...
 -Leonardo Rodriguez
[[\begin{center}
\includegraphics[width=.9\linewidth]{/home/samuchura-epn/imagenes/PythonEvidencia.jpeg}
\end{center}]]
-Samuel Churaco
[[\begin{center}
\includegraphics[width=.9\linewidth]{Imgess/infoMamba.png}
...
\end{verbatim}
 ...
 -Leonardo Rodriguez
[[\begin{center}
\includegraphics[width=.9\linewidth]{/home/samuchura-epn/imagenes/EmacsEvidencia.jpeg}
\end{center}]]
-Samuel Churaco
[[\begin{center}
\includegraphics[width=.9\linewidth]{Imgess/Emacsinf.png}
\end{center}]]
...
\end{verbatim}
 -Leonardo Rodriguez
[[\begin{center}
\includegraphics[width=.9\linewidth]{/home/samuchura-epn/imagenes/LatexEvidencia.jpeg}
\end{center}]]
 -Samuel Churaco
 [[\begin{center}
\includegraphics[width=.9\linewidth]{Imgess/Latexinf.png}
\end{center}]]
...
\endlastfoot
\hline
- C-h - 0 & Saltar entre ventadnas & C-x C-s & Guarda cambios\\[0pt]
- C-/  / & Deshacer & -C-g & Elimina la intencion de algun comando\\[0pt]
- C-d & Elimina al otrollado & C-v & saltos de parrafo\\[0pt]
\end{longtable}
<Estudiante C>
\begin{longtable}{|p{0.2\linewidth}|p{0.3\linewidth}|p{0.2\linewidth}|p{0.3\linewidth}|}
\textbf{Comando} & \textbf{Descripción} & \textbf{Comando} & \textbf{Descripción}\\[0pt]
...
Samuelchuraco & samuelchuraco@epn.edu.ec & Colaborador\\[0pt]
 &  & Colaborador\\[0pt]
\hline
\end{tabular}
\end{center}
