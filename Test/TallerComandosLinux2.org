...
2. Cree tres directorios denominados FashionData, Train y
   ...
   | FashionData                               |
   | PythonProjectExample                      |
   | Taller-CodingJupyter.ipynb                |
   | Taller-ConfiguracionEntorno.org           |
   | Taller-HardwareBasico.org                 |
   | Taller-Python-Emacs.org                   |
   | Taller-Representacion-Enteros-Signo.ipynb |
   | TallerComandosEmacs.org                   |
   | TallerComandosEmacs.pdf                   |
   | TallerComandosLinux.org                   |
   | TallerComandosLinux.pdf                   |
   | TallerDiscoDuro.org                       |
   | TallerDiscoDuro.pdf                       |
   | TallerIAS.org                             |
   | TallerIAS.pdf                             |
   | TallerScriptPython.org                    |
   | TallerScriptPython.pdf                    |
   | TallerUbuntuBoot.org                      |
   | TallerUbuntuBoot.pdf                      |
   | Test                                      |
   | Train                                     |
   | logoEpn.jpg                               |
...
3. Investigue sobre el comando ~wget~ y utilícelo para descargar en
   ...
   #+RESULTS:
   | total      | 30M |              |              |      |     |    |      |                            |
   | -rw-r--r-- |   1 | leningfe-epn | leningfe-epn | 4.3M | Aug | 31 | 2017 | t10k-images-idx3-ubyte.gz  |
   | -rw-r--r-- |   1 | leningfe-epn | leningfe-epn | 5.1K | Aug | 31 | 2017 | t10k-labels-idx1-ubyte.gz  |
   | -rw-r--r-- |   1 | leningfe-epn | leningfe-epn | 26M  | Aug | 31 | 2017 | train-images-idx3-ubyte.gz |
   | -rw-r--r-- |   1 | leningfe-epn | leningfe-epn | 29K  | Aug | 31 | 2017 | train-labels-idx1-ubyte.gz |
...
7. Los archivos anteriores están comprimidos. Investigue como
   ...
   #+begin_src shell :exports both
   tar -xOf Train/train-images-idx3-ubyte.gz > Train/train-images-idx3-ubyte
   tar -xOf Train/train-labels-idx1-ubyte.gz > Train/train-labels-idx1-ubyte
   tar -xOf Test/t10k-images-idx3-ubyte.gz > Test/t10k-images-idx3-ubyte
   tar -xOf Test/t10k-labels-idx1-ubyte.gz > Test/t10k-labels-idx1-ubyte
   echo "Train"
   ls Train
   echo "Test"
   ls Test
